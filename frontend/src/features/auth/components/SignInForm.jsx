...
function SignInForm() {
  ...
  return (
    <div className="flex flex-col items-center flex-1 h-full px-4 py-10 overflow-y-auto sm:py-16 no-scrollbar">
      <div className="w-full max-w-sm sm:w-[80%] md:w-[60%] lg:w-[50%]">
        ...
        <div className="text-[#f0e3c77c]">
          ...
          <p
            ...
            className="text-xs font-semibold text-[#F5A623] flex justify-end cursor-pointer mb-1"
          >
            Forgot Password?
          </p>
          <button
          ...
          <pre className="flex flex-wrap justify-center gap-1 font-sans text-xs">
            New to Nestly?{" "}
            <span
