...
function AddListing() {
  ...
  return (
    <div className="h-screen overflow-y-auto no-scrollbar py-5 px-4 sm:py-8 sm:px-8 text-[#e8d5b0]">
      <h1
      ...
      <p className="text-[#f0e3c77c] text-xs sm:text-sm mb-6 sm:mb-8">
      ...
      <Section title="Address">
        ...
        <div className="flex items-center gap-4 mt-4">
          <button
            ...
            className="flex items-center gap-2 border border-[#5a4626] rounded-xl px-4 py-2 text-xs sm:text-sm text-[#F5A623] hover:border-[#F5A623] transition-all cursor-pointer w-full sm:w-auto justify-center sm:justify-start"
          >
      ...
      <Section title="Room Details">
        ...
        <div className="flex items-center justify-between mt-4 bg-[#1a1208] border border-[#3d2b0f] rounded-xl px-4 py-3">
          <span className="text-xs sm:text-sm text-[#a07840]">
            Food included?
          </span>
          <button
            onClick={() =>
        ...
        <div className="flex flex-wrap gap-2">
          {amenitiesList.map((a) => (
            <button
              ...
              className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs font-semibold border transition-all duration-200 cursor-pointer
                ${
      ...
      <Section title="Photos">
        <label className="flex flex-col items-center justify-center border border-dashed border-[#3d2b0f] rounded-xl py-6 sm:py-8 cursor-pointer hover:border-[#F5A623] transition-all">
          <span className="mb-2 text-2xl">📷</span>
          <span className="text-xs sm:text-sm text-[#5a4626] text-center px-4">
        ...
        {previews.length > 0 && (
          <div className="grid grid-cols-3 gap-2 mt-4 sm:grid-cols-4 sm:gap-3">
            {previews.map((src, i) => (
              <div key={i} className="relative">
                <img
                  src={src}
                  alt=""
                  className="w-full h-20 sm:h-24 object-cover rounded-xl border border-[#3d2b0f]"
                />
                <button
                  onClick={() => {
      ...
      <div className="flex flex-col-reverse justify-end gap-3 pb-8 sm:flex-row sm:gap-4">
        <button
          onClick={() => {
            dispatch(clearEditListing());
            dispatch(setOwnerView("Dashboard"));
          }}
          className="border border-[#3d2b0f] rounded-xl px-6 py-3 text-sm text-[#7a5c30] cursor-pointer hover:border-[#F5A623] transition-all w-full sm:w-auto text-center"
        >
          Cancel
        </button>
        <button
          ...
          disabled={loading}
          className="bg-[#F5A623] cursor-pointer text-black font-bold rounded-xl px-8 py-3 text-sm hover:-translate-y-0.5 transition-all w-full sm:w-auto text-center"
        >
          {loading
            ? editListing
              ? "Updating..."
