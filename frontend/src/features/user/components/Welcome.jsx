  ...
  return (
    <div className='flex items-center justify-between p-8 bg-[#261A0A] rounded-2xl m-6 border border-[#5a4626]'>
      <div className='flex flex-col gap-2 '>
        <h1 style={{fontFamily: "Playfair Display, serif"}} className='text-3xl font-bold text-[#F0E8D8]'>Welcome back, <span className='text-[#F5A623]'>Riya!</span> 👋</h1>
        <p className='text-[#867a5f] text-sm font-medium '>You have 3 new messages and 2 upcoming visits this week</p>
      </div>
      <div className='flex gap-8'>
        <div className='flex flex-col items-center bg-[#342310] px-5 py-2 rounded-lg border border-[#5a4626] leading-7 cursor-pointer'>
            ...
            <p className='text-xs uppercase font-mono text-[#867a5f] font-medium' >saved</p>
        </div>
        <div className='flex flex-col items-center bg-[#342310] px-5 py-2 rounded-lg border border-[#5a4626] leading-7 cursor-pointer'>
